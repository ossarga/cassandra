...
public class ProgressBarrier
{
    ...
    private static final long TIMEOUT_MILLIS = CassandraRelevantProperties.PROGRESS_BARRIER_TIMEOUT_MILLIS.getLong();
    private static final long BACKOFF_MILLIS = CassandraRelevantProperties.PROGRESS_BARRIER_BACKOFF_MILLIS.getLong();
