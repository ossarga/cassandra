...
public class GossipHelper
{
    ...
    public static void withProperty(String prop, boolean value, ThrowingRunnable r)
    {
        withProperty(prop, Boolean.toString(value), r);
    }

    private static void withProperty(String prop, String value, ThrowingRunnable r)
    {
